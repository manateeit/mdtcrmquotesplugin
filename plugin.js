 ...
 */
plugin.controller('quotesCntl', ['$scope', 'znData', '$routeParams', 'znModal','$templateCache', '$timeout', 'quotesCompanySvc', 'quotesDataShare','$location',
        function ($scope, znData, $routeParams, znModal,$templateCache, $timeout, quotesCompanySvc, quotesDataShare, $location) {
            ...
            return {
                ...
                childSave: function childSave(companyModel, newQuote, quoteItems) {
                    ...
                    var recordObj = {
                            ...
                            company : {'name': companyModel.name, 'id': companyModel.id},
